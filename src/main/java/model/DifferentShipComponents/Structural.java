...
/**
 * Extension of ship component: it represents the structural component
 * @see ShipComponent
 */
public class Structural extends ShipComponent{
    ...
    public Structural(
        ...
        super(ComponentType.STRUCTURAL,northSide,eastSide,southSide,westSide, ID,image);
    }
    ...
    public Structural(
        ...
        super(ComponentType.STRUCTURAL,northSide,eastSide,southSide,westSide, -1,image);
    }
    ...
    public ShipComponent clone() {
        Structural newComp = new Structural(this.getNorthSide(), this.getEastSide(), this.getSouthSide(),
