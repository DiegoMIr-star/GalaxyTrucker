...
/**
 * Message sent to client to put him in a waiting room
 */
public class WaitingPartnersMessage extends Message {

    /**
     * Constructor of the message
     */
    public WaitingPartnersMessage() {super("Server",MessageKind.WAITING);}
