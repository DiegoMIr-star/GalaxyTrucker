...
/**
 * Message sent to the server in order to draw a specific component
 */
public class DrawSpecificComponentRequestMessage extends Message implements Serializable {
	 ...
	 */
	public DrawSpecificComponentRequestMessage(String nickname, int id) {
		super(nickname, MessageKind.DRAW_COMP_REQUEST);
		this.id = id;
	}
