...
/**
 * Message sent to the server in order to draw a component
 */
public class DrawComponentRequestMessage extends Message implements Serializable {

    /**
     * Message constructor
     * @param nickname player nickname
     */
    public DrawComponentRequestMessage(String nickname) {super(nickname, MessageKind.DRAW_COMP_REQUEST);}
