...
/**
 * Message sent to the server used to discard some stocks
 */
public class DiscardStocksMessage extends Message{

	/**
	 * Stocks to discard
	 */
	Stocks stocksToDiscard;

	/**
	 * Message constructor, used to initialize the stocks to discard
	 * @param nickname player nickname
	 * @param stocks stocks to discard
	 */
	public DiscardStocksMessage(String nickname, Stocks stocks){
		super(nickname, MessageKind.DISCARD_STOCKS);
		stocksToDiscard = stocks;
	}

	/**
	 * Getter of discarded stocks
	 * @return stocks to discard
	 */
	public Stocks getStocksToDiscard() {return stocksToDiscard;}
