...
/**
 * Message sent to the server in order to ask the available small decks
 */
public class AvailableSmallDecksRequestMessage extends Message implements Serializable {

    /**
     * Message constructor
     * @param nickname player nickname
     */
    public AvailableSmallDecksRequestMessage(String nickname) {super(nickname, MessageKind.GET_AVAILABLE_SMALL_DECKS);}
