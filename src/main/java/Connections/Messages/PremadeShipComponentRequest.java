...
/**
 * Message sent to the server in order to ask a pre-made ship component
 */
public class PremadeShipComponentRequest extends Message implements Serializable {
	 ...
	 */
	public PremadeShipComponentRequest(String nickname, int id) {
