...
/**
 * Message sent to the server in order to restart the timer
 */
public class StartTimerRequestMessage extends Message implements Serializable {

    /**
     * Constructor of the message
     * @param nickname nickname of the client who sends the message
     */
    public StartTimerRequestMessage(String nickname) {super(nickname, MessageKind.START_TIMER_REQUEST);}
