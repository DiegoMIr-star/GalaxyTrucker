...
/**
 * Class for representation of ship construction state
 */
public class ShipConstructionState extends GameState {
     ...
     */
    @Override
    public String toString() {return "ShipsConstructionState";}
     ...
     */
    @Override
    public ShipConstructionState clone() {return (ShipConstructionState) super.clone();}
}
