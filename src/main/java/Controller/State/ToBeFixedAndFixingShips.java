...
/**
 * Class for representation of to be fixed and fixing ships state
 */
public class ToBeFixedAndFixingShips extends GameState {
     ...
     */
    @Override
    public String toString() {return "ToBeFixedAndFixingShips state";}
     ...
     */
    @Override
    public ToBeFixedAndFixingShips clone() {return (ToBeFixedAndFixingShips) super.clone();}
}
