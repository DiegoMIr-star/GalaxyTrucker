...
/**
 * Class for representation of docking choice
 */
public class DockingChoice extends GameState {
     ...
     */
    @Override
    public String toString() {return "DockingChoice state";}
     ...
     */
    @Override
    public DockingChoice clone() {return (DockingChoice) super.clone();}
}
