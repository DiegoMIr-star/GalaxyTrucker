 ...
 */
public class FirePowerChoice extends GameState {
     ...
     */
    @Override
    public String toString() {return "FirePowerChoice state";}
     ...
     */
    @Override
    public FirePowerChoice clone() {return (FirePowerChoice) super.clone();}
}
