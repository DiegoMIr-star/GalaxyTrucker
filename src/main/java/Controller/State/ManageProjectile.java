...
/**
 * Class for representation of manage projectile
 */
public class ManageProjectile extends GameState {
     ...
     */
    @Override
    public String toString() {return "ManageProjectile state";}
     ...
     */
    @Override
    public ManageProjectile clone() {return (ManageProjectile) super.clone();}
}
