...
/**
 * Class for representation of give up crew choice
 */
public class GiveUpCrewChoice extends GameState {
     ...
     */
    @Override
    public String toString() {return "GiveUpCrewChoice state";}
     ...
     */
    @Override
    public GiveUpCrewChoice clone() {return (GiveUpCrewChoice) super.clone();}
}
