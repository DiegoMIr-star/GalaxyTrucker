...
/**
 * Class for representation of card drawing
 */
public class CardDrawing extends GameState {
     ...
     */
    @Override
    public String toString() { return "Card Drawing state"; }
     ...
     */
    @Override
    public CardDrawing clone() {return (CardDrawing) super.clone();}
}
