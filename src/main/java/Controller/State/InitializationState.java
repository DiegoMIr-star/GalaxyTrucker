...
/**
 * Class for representation of initialization
 */
public class InitializationState extends GameState {
     ...
     */
    @Override
    public String toString() {return "InitializationState";}
     ...
     */
    @Override
    public InitializationState clone() {return (InitializationState) super.clone();}
}
