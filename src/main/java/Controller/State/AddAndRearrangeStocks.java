...
/**
 * Class for representation of add and rearrange stocks
 */
public class AddAndRearrangeStocks extends GameState {
     ...
     */
    @Override
    public String toString() { return "AddAndRearrangeStocks state"; }
     ...
     */
    @Override
    public AddAndRearrangeStocks clone() {return (AddAndRearrangeStocks) super.clone();}
}
